...
% In this section Videos are saved in Videos_set6H folder
% To check if Videos_set6H folder exists otherwise to create
if not(isfolder('Videos_set6H'))
    mkdir('Videos_set6H')
end
...
videofile = VideoWriter(strcat('Videos_set6H/Tumor_set6H', video_ext),v_pro);
...
videofile = VideoWriter(strcat('Videos_set6H/Acidity_set6H', video_ext),v_pro);
videofile.Quality = 100;
videofile.FrameRate = 10;
open(videofile);
...
videofile = VideoWriter(strcat('Videos_set6H/EC_set6H', video_ext),v_pro);
videofile.Quality = 100;
videofile.FrameRate = 10;
open(videofile);
...
videofile = VideoWriter(strcat('Videos_set6H/VEGF_set6H', video_ext),v_pro);
videofile.Quality = 100;
videofile.FrameRate = 10;
open(videofile);
for i = 1: size(S_total,3)
...
for i = 1:10:size(M_total,3)
    ...
    xlabel('X' , 'Fontsize', 15);
    ylabel('Y' , 'Fontsize', 15);
    %     saveas(gcf,sprintf('Plots_set6H/Tumor_set6H_%ddays',3*(i-1)),'epsc');%eps
    saveas(gcf,sprintf('Plots_set6H/Tumor_set6H_%ddays.png',3*(i-1)));%png
    ...
    xlabel('X' , 'Fontsize', 15);
    ylabel('Y' , 'Fontsize', 15);
    %     saveas(gcf,sprintf('Plots_set6H/Acidity_set6H_%ddays',3*(i-1)),'epsc');
    saveas(gcf,sprintf('Plots_set6H/Acidity_set6H_%ddays.png',3*(i-1)))
    ...
    xlabel('X' , 'Fontsize', 15);
    ylabel('Y' , 'Fontsize', 15);
    %     saveas(gcf,sprintf('Plots/EC_set6H_%ddays',3*(i-1)),'epsc');
    saveas(gcf,sprintf('Plots_set6H/EC_set6H_%ddays.png',3*(i-1)))
    ...
    xlabel('X' , 'Fontsize', 15);
    ylabel('Y' , 'Fontsize', 15);
    %     saveas(gcf,sprintf('Plots/VEGF_set6H_%ddays',3*(i-1)),'epsc');
    saveas(gcf,sprintf('Plots_set6H/VEGF_set6H_%ddays.png',3*(i-1)))
...
save('Mat_files/main_2D_set6H.mat');
%%
toc