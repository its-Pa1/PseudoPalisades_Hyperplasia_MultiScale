...
t = 0:dt:15;
%%
[DT,M_full, S_full, W_full, G_full] = compute_full_model_pattern_const();
[M_WL, S_WL, W_WL, G_WL] = compute_W_L_flux_const();
%%
M_diff = M_full - M_WL;
S_diff = S_full - S_WL;
W_diff = W_full - W_WL;
...
saveas(gcf,'Plots_pattern_W_L_flux/Tumor_pattern_W_L_flux.png');
%%
figure(2)
surf(x,t,S_WL')
view(0,90)
...
axis tight
saveas(gcf,'Plots_pattern_W_L_flux/Acidity_pattern_W_L_flux.png');
%%
figure(3)
surf(x,t,W_WL')
view(0,90)
...
axis tight
saveas(gcf,'Plots_pattern_W_L_flux/EC_pattern_W_L_flux.png');
%%
figure(4)
surf(x,t,G_WL')
view(0,90)
...
axis tight
saveas(gcf,'Plots_pattern_W_L_flux/VEGF_pattern_W_L_flux.png');
%%
figure(5)
surf(x,t,M_diff')
view(0,90)
...
axis tight
% axis([280 440 0, t(end)]);
saveas(gcf,'Plots_pattern_W_L_flux/Tumor_pattern_diff.png');
%%
figure(6)
surf(x,t,S_diff')
view(0,90)
...
axis tight
saveas(gcf,'Plots_pattern_W_L_flux/Acidity_pattern_diff.png');
%%
figure(7)
surf(x,t,W_diff')
view(0,90)
...
axis tight
saveas(gcf,'Plots_pattern_W_L_flux/EC_pattern_diff.png');
%%
figure(8)
surf(x,t,G_diff')
view(0,90)
...
axis tight
saveas(gcf,'Plots_pattern_W_L_flux/VEGF_pattern_diff.png');
%%
DT = zeros(1,length(x))+DT;
figure(9)
plot(x,DT, 'Linewidth', 1.5)
xlabel('X' , 'Fontsize', 15);
ylabel('D_T' , 'Fontsize', 15);
axis([0 x(end) 0 2*max(DT)])
title('D_T', 'Fontsize', 15);
saveas(gcf,'Plots_pattern_W_L_flux/Diff_coeff.png');
%%
figure(10)
surf(x,t,M_full')
view(0,90)
colorbar
caxis([0 .7e-5]) % as matlab colormap has only few colors, a differnce of order 100 make eveything blue
% so this command colors red all the values above its second argument(e.g here 2e-4)
shading interp
colormap jet
xlabel('X' , 'Fontsize', 15);
...
axis tight
% axis([280 440 0, t(end)]);
saveas(gcf,'Plots_pattern_W_L_flux/Tumor_pattern_full_model.png');
%%
figure(11)
surf(x,t,S_full')
view(0,90)
...
axis tight
saveas(gcf,'Plots_pattern_W_L_flux/Acidity_pattern_full_model.png');
%%
figure(12)
surf(x,t,W_full')
view(0,90)
...
axis tight
saveas(gcf,'Plots_pattern_W_L_flux/EC_pattern_full_model.png');
%%
figure(13)
surf(x,t,G_full')
view(0,90)
...
axis tight
saveas(gcf,'Plots_pattern_W_L_flux/VEGF_pattern_full_model.png');
