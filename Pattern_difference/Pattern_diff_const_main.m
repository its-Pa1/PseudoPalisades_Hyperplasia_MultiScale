...
t = 0:dt:15;
%%
[M_old, S_old] = compute_pattern_old_const();
[DT,M_new, S_new, W_new, G_new] = compute_pattern_new_const();
%%
M_diff = M_new - M_old;
S_diff = S_new - S_old;
...
view(0,90)
colorbar
caxis([0 1.5e-5]) % as matlab colormap has only few colors, a differnce of order 100 make eveything blue
% so this command colors red all the values above its second argument(e.g here 1.5e-5)
shading interp
colormap jet
...
saveas(gcf,'Plots_pattern_diff/Tumor_pattern_old_const.png');
%%
figure(2)
surf(x,t,S_old')
view(0,90)
...
axis tight
saveas(gcf,'Plots_pattern_diff/Acidity_pattern_old_const.png');
%%
figure(3)
surf(x,t,M_new')
view(0,90)
...
axis tight
% axis([280 440 0, t(end)]);
saveas(gcf,'Plots_pattern_diff/Tumor_pattern_new_const.png');
%%
figure(4)
surf(x,t,S_new')
view(0,90)
...
axis tight
saveas(gcf,'Plots_pattern_diff/Acidity_pattern_new_const.png');
%%
figure(5)
surf(x,t,W_new')
view(0,90)
...
axis tight
saveas(gcf,'Plots_pattern_diff/EC_pattern_new_const.png');
%%
figure(6)
surf(x,t,G_new')
view(0,90)
...
axis tight
saveas(gcf,'Plots_pattern_diff/VEGF_pattern_new_const.png');
%%
figure(7)
surf(x,t,M_diff')
view(0,90)
...
axis tight
% axis([280 440 0, t(end)]);
saveas(gcf,'Plots_pattern_diff/Tumor_pattern_diff_const.png');
%%
figure(8)
surf(x,t,S_diff')
view(0,90)
...
axis tight
saveas(gcf,'Plots_pattern_diff/Acidity_pattern_diff_const.png');
%%
...
saveas(gcf,'Plots_pattern_diff/Diff_coeff.png');